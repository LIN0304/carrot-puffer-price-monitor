...
const CONFIG = {
  ...
  checkInterval: 210 * 60 * 1000, // <--- SET check interval (e.g., 10 * 60 * 1000 for 10 minutes)
  // Minimum interval between notifications (in minutes)
  // Priority: Command line (--notify-interval X) -> Default (10 mins)
  notifyInterval: notifyIntervalArg || (210 * 60 * 1000), // <--- SET default notification interval (e.g., 30 * 60 * 1000 for 30 minutes)
  // Log file location
